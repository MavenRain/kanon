"""Check disclosure of the dependent coherence API and permitted axioms."""
...
# because this record retains the axiom output of the coherence increment.
owned = "meta/KanonMeta/MuFinitaryElimCoherence.lean"
sources = {
...
report = {"passed": passed, "reports": len(reports), "missing": missing,
          ...
          "coherence_api_reports": {name: reports.get(name)
