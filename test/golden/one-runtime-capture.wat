(module
 ...
 (type $5 (func (param (ref eq)) (result (ref $2))))
 ...
 (func $1 (type $5) (param $0 (ref eq)) (result (ref $2))
  (struct.new $2
   (local.get $0)
   (struct.new $3
    (i32.const 0)
 ...
 (func $5 (type $5) (param $0 (ref eq)) (result (ref $2))
  (struct.new $2
   (local.get $0)
   (struct.new $3
    (i32.const 1)
 ...
 (func $7 (type $6) (param $0 (ref eq)) (result (ref eq))
  (return_call $6)
 )
 (func $8 (type $5) (param $0 (ref eq)) (result (ref $2))
  (struct.new $2
   (local.get $0)
   (struct.new $3
    (i32.const 1)
 ...
 (func $9 (type $6) (param $0 (ref eq)) (result (ref eq))
  (ref.i31
   (i32.const 0)
  )
 )
 (func $10 (type $5) (param $0 (ref eq)) (result (ref $2))
  (struct.new $2
   (local.get $0)
   (struct.new $3
    (i32.const 1)
 ...
 (func $12 (type $6) (param $0 (ref eq)) (result (ref eq))
  (return_call $0)
 )
 ...
 (func $17 (type $11) (param $0 (ref eq)) (result i32)
  (local $1 i32)
  (local.set $1
   (i31.get_u
 ...
 (func $18 (type $12) (param $0 (ref eq)) (param $1 i32) (result i32)
  (local $2 (ref $0))
  (local $3 i32)
  (local.set $3
   (i31.get_u
 ...
 (func $19 (type $13) (param $0 (ref $0)) (param $1 (ref $0)) (param $2 i32) (param $3 i32) (result (ref $0))
  (if (result (ref $0))
   (i32.lt_u
    (local.get $2)
    (local.get $3)
 ...
 (func $20 (type $14) (param $0 (ref $0)) (param $1 i32) (result (ref eq))
  (if (result (ref eq))
   (i32.eq
    (local.get $1)
    (i32.const 0)
 ...
 (func $21 (type $15) (param $0 (ref eq)) (param $1 (ref eq)) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  (if (result i32)
   (i32.eq
 ...
 (func $22 (type $16) (param $0 (ref eq)) (param $1 (ref eq)) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local.set $2
   (call $17
 ...
 (func $23 (type $9) (param $0 (ref eq)) (param $1 (ref eq)) (param $2 (ref $0)) (param $3 i32) (param $4 i32) (param $5 i32) (result (ref eq))
  (local $6 i32)
  (if (result (ref eq))
   (i32.eq
    (local.get $3)
 ...
 (func $26 (type $1) (param $0 (ref eq)) (param $1 (ref eq)) (result (ref eq))
  (local $2 i32)
  (local $3 i32)
  (local.set $2
   (call $17
